...
const COLUMNS = [
  ...
  { key: "thdnMic",          label: "THD+N Mic In (dB(%), 1kHz)",   labelJa: "THD+N マイク入力 (dB(%), 1kHz)" },
  { key: "thdnOut",          label: "THD+N Out (dB(%), 1kHz)",      labelJa: "THD+N 出力 (dB(%), 1kHz)" },
  { key: "thdnUnknown",      label: "THD+N (dB(%), Unspecified)",   labelJa: "THD+N (dB(%), 条件不明)" },
